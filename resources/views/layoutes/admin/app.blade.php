...
<body>
    ...
    <a href="{{ route('admin.stores.index') }}" class="menu-item">
        <i class="fas fa-store"></i>
        <span>Kelola stores</span>
    </a>
    ...
    <div class="navbar d-flex justify-content-between align-items-center">
        ...
        <div class="admin-section">
            <a class="admin-profile" href="{{ route('admin.stores.index') }}">
                <div class="avatar">
                    <i class="fas fa-user"></i>
                </div>
                <span class="admin-name">Profil stores</span>
            </a>
